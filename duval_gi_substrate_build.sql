...
-- Step 2: Populate zone_standards for key districts
...
-- Step 3: Create parcel_zones mapping  
-- This would typically be done via spatial analysis of GIS data
-- For now, create framework and populate with representative distribution
...
-- Step 4: Create permitted_uses for key districts
...
-- Verify G and I metrics can now be calculated
SELECT 'G METRIC VERIFICATION' as check_type, * 
FROM v_zoning_gold_standard_kpi_v3 
WHERE county_slug = 'duval';

-- Log the substrate build
INSERT INTO migration_log (migration_name, applied_at, description)
VALUES (
    'duval_gi_substrate_build',
    NOW(),
    'Duval G+I substrate build: zoning_districts, zone_standards, parcel_zones for Jacksonville Ch.656'
