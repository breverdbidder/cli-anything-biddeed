...
| R009 | XGBoost/scoring model producing inaccurate auction predictions (financial harm) | 3 | 4 | 12 | Shapira Max Bid ceiling, UPL disclaimer on every report | MEDIUM | Ariel | ACCEPTED — disclosed via disclaimer, not a solved-model claim |
