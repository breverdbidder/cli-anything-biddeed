# Anti-patterns: LLM Coding Pitfalls (Evolver Fitness Corpus)

> **Source:** [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) @ `2c60614` · MIT (per metadata) · derived from [Karpathy tweet 2015883857489522876](https://x.com/karpathy/status/2015883857489522876)
> **Imported:** 2026-05-25 by Claude Opus 4.7 via EXTREP intake `213e62ef-754b-4535-98da-1b3c21d51310`
> **Purpose:** Reference corpus for AUTOLOOP V2 evolver fitness function. Each section pairs an LLM-generated anti-pattern with a corrected approach. Maps 1:1 to Karpathy guidelines K1–K4 already encoded in /CLAUDE.md.
> **Crossrefs:** docs/EVEREST-GATE.md (K1–K4 gate definitions) · /CLAUDE.md § KARPATHY_DISCIPLINE_BEGIN
> **License:** MIT (per source SKILL.md frontmatter). LICENSE file PR opened upstream — see breverdbidder/andrej-karpathy-skills branch add-mit-license.
