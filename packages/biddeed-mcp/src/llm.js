// claude-router v4 client for biddeed-mcp
 ...
 * @returns {Promise<{text: string, provider: string, tier: string, model: string, input_tokens: number, output_tokens: number, cost_usd: number, latency_ms: number, request_id: string} | null>}
