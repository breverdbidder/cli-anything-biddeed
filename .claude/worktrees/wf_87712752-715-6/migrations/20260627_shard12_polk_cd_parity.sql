-- SHARD-12 polk C/D parity fix
-- Session: architect-20260627T160000
-- Context: frozen-numerator — denominator grew, re-run promotion
...
-- Step 3: Remaining NULL parity PO rows (partial data) → matched_divergent
UPDATE multi_county_auctions
