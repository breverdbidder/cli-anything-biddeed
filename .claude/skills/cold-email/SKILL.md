...
Understand the situation (infer from repo/session context; if unknown, state the assumption and tag it INFERRED rather than blocking to ask — this runs zero-HITL):
