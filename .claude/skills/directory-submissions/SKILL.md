...
Answer these 9 readiness questions from repo/product context (tag each INFERRED if assumed). If any are "no", they're not ready — build the missing piece first rather than blocking to ask — this runs zero-HITL.
