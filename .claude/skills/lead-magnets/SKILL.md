...
# Lead Magnets
> **Everest context:** vendored from `coreyhaines31/marketingskills` (MIT, SHA `d4ff28a9c8d56c06809860bf2800d4f5224b52db`, 2026-09-01) — see `.claude/skills/README.md`. MANDATE M3 applies to client-facing output (no internal vendor/tool/methodology names, no issue/run IDs). Runs zero-HITL: ask-user gates below are adapted to infer-and-tag-INFERRED.
...
Gather this context (infer from repo/session context or `.agents/product-marketing.md`; if truly unknown, state the assumption and tag it INFERRED per Honesty Protocol rather than blocking to ask — this runs zero-HITL):
