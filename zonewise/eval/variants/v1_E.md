<!-- VARIANT E — Generation 1 -->
<!-- Strategy: Aggressive gotcha mining: add an adversarial self-check step where the skill reviews its own output for hallucinations before returning. -->
<!-- Failures addressed:
