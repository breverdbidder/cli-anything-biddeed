<!-- VARIANT A — Generation 1 -->
<!-- Strategy: Stricter evidence rules: require a source citation for every factual claim in the output. Add explicit instructions to quote source values verbatim. -->
<!-- Failures addressed:
  - T1_A2: Every record contains a parcel_id field matching Brevard format (##-##-##-##-#####.#-####.#)
  - T1_A3: Every record contains a non-null zone_code field
  - T1_A4: Every record contains a non-null zone_name field
  - T1_A5: zone_code values match known Brevard zoning codes (BU, GU, RS, RU, AU, IU, PUD, etc.)
  - T2_A1: Output includes total_parcels as integer > 0
  - T2_A2: Output includes matched_parcels as integer > 0
  - T2_A3: Match rate (matched/total) is >= 0.95 (95%)
  - T2_A4: Output includes unmatched_parcels array (even if empty)
  - T2_A5: Processing time is reported in seconds as numeric value
  - T3_A1: Output contains municipality field set to 'Palm Bay'
-->
