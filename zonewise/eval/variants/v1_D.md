<!-- VARIANT D — Generation 1 -->
<!-- Strategy: Domain-specific focus: add heavier prompting on the known weak areas identified in the failure analysis. Be very specific about expected values. -->
<!-- Failures addressed:
