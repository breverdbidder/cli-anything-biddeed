#!/usr/bin/env python3
"""GOLD STANDARD shard-3 lake (dispatch 77ac9cef): J single-row generation for
case 2026CA000288, whose parcel_id/address/assessed_value this same session
just real-verified and wrote (Lake Clerk defendant-name match -> Property
Appraiser owner record, FieldMap-confirmed parcel_id). Same Shapira V14
generator/model artifact and non-fabrication contract as prior lake J passes.
"""
...
REPAIR_TAG = "lake_j_generator_shard3_1row_000288_shapira_v14_real"
