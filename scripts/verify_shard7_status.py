...
Check current A-J letter grades for highlands, suwannee, martin, columbia, madison
...
def main():
    ...
    if evaluated_counties > 0:
        print("\nNext steps based on sprint priorities:")
        print("1. C/D ROOT CAUSE - parity audit vs PropertyOnion coverage")
        print("2. J GENERATOR - bid_decisions pipeline (arv+max_bid+ml_score+factors)")
        print("3. G HIT LIST - zone_standards NULL backfill for key districts")
        print("4. B RECONCILIATION - verified_outcomes > closed_sold anomaly")
