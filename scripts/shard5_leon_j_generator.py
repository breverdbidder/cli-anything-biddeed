#!/usr/bin/env python3
"""
SHARD-5 Criterion J Generator — leon / highlands / bradford / wakulla
...
Strategy:
  1. Fetch all MCA rows for each county (paginated, 500/page)
  2. Fetch existing bid_decisions by county_slug to find gaps
  ...
  5. Call pencil_dod_evaluate_county (p_county param) and report J metric

Do NOT touch collier (already J=100%).
"""
...
TARGET_COUNTIES = ["leon", "highlands", "bradford", "wakulla"]
...
PIPELINE_RUN_ID = "shard5-j-generator-v1"
...
def main():
    print("SHARD-5 Criterion J Generator — leon / highlands / bradford / wakulla")
