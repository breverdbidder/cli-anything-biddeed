...
REAL J generator for washington's 2026-08-18 tax-deed batch, forked verbatim
(methodology) from scripts/gold_standard_shard1_a3eafa08_washington_j_generator_real.py
(the a3eafa08 session that already did this exact thing for the 2026-08-11 batch),
which itself forks scripts/gold_standard_shard9_osceola_run255f_j_generator_real.py --
real per-property Shapira V14 XGBoost inference (shapira_models.model_version='v14.0',
AUC 0.7834, storage_bucket shapira-models), no county-level or ml-score-bucket
defaults, BLANK > WRONG for rows with no real value on file. Adds stage_model()
(pattern from scripts/gold_standard_highlands_j_generator_real.py) since /tmp/shapira
is not guaranteed pre-populated in this session.

washington IS in the v14 training corpus's county_target_encoding_map (real trained
rate 0.875, confirmed live from shapira-models/v14/2026-05-27-180308/metrics.json,
same value the a3eafa08 session used) -- reused directly, no fallback needed.

Live diagnosis this session (direct multi_county_auctions vs bid_decisions join,
after this same session's C/D/I parity+geo+zoning fix moved washington 6/10->9/10):
exactly 15 washington case_numbers fail the deal_complete definition -- 2026-TD-100/
107/108/110/111/113/114/115/116/117/118/120/125/126/127, all auction_date 2026-08-18
(today's washington.realtaxdeed.com sale, just harvested this session), all with
zero existing bid_decisions row (first-time fill).
"""
...
COUNTY = "washington"
TARGET_CASE_NUMBERS = {
    "2026-TD-100", "2026-TD-107", "2026-TD-108", "2026-TD-110", "2026-TD-111",
    "2026-TD-113", "2026-TD-114", "2026-TD-115", "2026-TD-116", "2026-TD-117",
    "2026-TD-118", "2026-TD-120", "2026-TD-125", "2026-TD-126", "2026-TD-127",
}
NEED_FACTOR_KEYS = {"distress_location", "distress_property", "distress_owner", "cma_distressed", "cma_resale"}
COUNTY_TARGET_ENC = 0.875
PIPELINE_VERSION = "architect_triage_19313_washington_shapira_v14_real"
