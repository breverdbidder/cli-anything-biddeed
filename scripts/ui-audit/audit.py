...
# The audit samples computed browser colors, so the set includes exact token values
# plus deterministic Chromium anti-aliased/composited samples. No legacy blue/gold
# colors are allowed.
