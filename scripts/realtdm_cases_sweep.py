#!/usr/bin/env python3
"""Brevard RealTDM public case-list sweep -> pipeline.brevard_realtdm_cases.

Decoded 2026-06-11 (Summit session). Public portal, no auth, not IP-blocked:
  POST https://brevard.realtdm.com/public/cases/list
...
Usage: realtdm_cases_sweep.py [MM/DD/YYYY start] [MM/DD/YYYY stop]
...
BASE = "https://brevard.realtdm.com"
...
if __name__ == "__main__":
    ...
    while page <= 60:
        ...
        rpc("upsert_brevard_realtdm_cases", new)
        written += len(new)
