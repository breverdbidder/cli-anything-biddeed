...
Usage:
  python scripts/mindstudio_run_agents.py --agent 3
  python scripts/mindstudio_run_agents.py --agent 1
  python scripts/mindstudio_run_agents.py
...
def mindstudio_run(app_id: str, workflow: str, variables: dict) -> dict:
    payload = {
        "appId": app_id,
        "workflow": workflow,
        "variables": variables,
...
def run_agent3_scorer(app_id: str) -> dict:
    ...
    for lead in leads:
        ...
        result = mindstudio_run(app_id=app_id, workflow="Score Lead", variables=variables)
...
def run_agent1_broadcaster(app_id: str) -> dict:
    ...
    for lead in leads:
        ...
        result = mindstudio_run(app_id=app_id, workflow="Broadcast", variables=variables)
