...
REPAIR_TAG = "lake_j_generator_run_shard2_shapira_v14_real_v2"
...
TARGET_CASE_NUMBERS = [
    ...
    "2025CA000447", "2025CA001183", "2025CA001896", "2025CA002247",
    "2025CA002532", "2025CC005881",
]
...
def main():
    ...
    if skipped_no_value > 0:
        print(f"ERROR: {skipped_no_value} target rows had no real assessed/market value — "
              f"scope was supposed to guarantee all 11 have real assessed_value. Aborting.", file=sys.stderr)
        sys.exit(1)
