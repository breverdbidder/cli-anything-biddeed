...
{
  "slug": "redemption",
  "title": "The Right of Redemption in a Florida Foreclosure",
  "meta_description": "Florida's right of redemption lets a borrower stop a foreclosure sale by paying it off — but only until a specific point. Here's when it ends.",
  "question": "What is the right of redemption in a Florida foreclosure?",
  "scope": "statewide",
  "statutes": [
    {
      "code": "45.0315",
  ...
  "faq": [
    { "q": "Can a foreclosure sale be stopped after the auction happens?", "a": "No — the right of redemption ends when the certificate of sale is filed; that is the outer edge of the window." },
