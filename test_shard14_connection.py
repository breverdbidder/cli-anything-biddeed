#!/usr/bin/env python3
"""
Test database connectivity and current Gold Standard status for Shard-14 counties
"""
import os
import sys
import json
    ...
    try:
        ...
        if r.status_code == 200:
            ...
            if isinstance(result, list) and len(result) > 0:
                ...
                # Count passes
                passes = sum(1 for item in result if item.get('pass'))
                print(f"  TOTAL: {passes}/10 passing")
            return result
        else:
...
if __name__ == "__main__":
    print("=== SHARD-14 Database Connectivity Test ===")
    
    if not test_connection():
        sys.exit(1)
    
    print("\n=== Fresh County Evaluations for Shard-14 ===")
    # Shard-14 assigned counties: osceola, gilchrist, seminole, hamilton
    assigned_counties = ['osceola', 'gilchrist', 'seminole', 'hamilton']
