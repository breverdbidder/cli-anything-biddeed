...
// TODO: Replace PENDING_AGENT_ID with the real ElevenLabs agent ID once the API key is rotated.
// Everything else is fully wired — swapping this const is the only remaining step.
export const AGENT_ID = 'PENDING_AGENT_ID';
