#!/usr/bin/env python3
"""
Check Gold Standard status for SHARD-21 counties: charlotte, citrus, broward
"""
import os
import sys
import json
...
if not SUPABASE_KEY:
    ...
    print("Note: Running without API key - will continue with script analysis")
...
if __name__ == "__main__":
    print("=== SHARD-21 Database Connectivity Test ===")
    ...
    print("\n=== Expected Status (from issue brief) ===")
    print("charlotte (3/10): A✓ H✓ | B❌ C❌ D✓ E❌ F❌ G❌ I❌ J❌")
    print("citrus (3/10): A✓ E✓ H✓ | B❌ C❌ D❌ F❌ G❌ I❌ J❌")  
    print("broward (2/10): A✓ H✓ | B❌ C❌ D❌ E❌ F❌ G❌ I❌ J❌")