...
COMMENT ON VIEW v_bid_decisions_j_metrics IS 'J letter metrics for SHARD-13 counties: bid_decisions completeness per Shapira Formula contract';

-- SHARD-13 specific verification query for ULTRALOOP protocol
