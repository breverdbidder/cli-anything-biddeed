#!/usr/bin/env python3
"""
Database connectivity test for brevard and duval Gold Standard autopilot session
"""
import os
import sys
import json
...
def get_current_gold_standard_status():
    """Get current Gold Standard metrics for brevard and duval"""
...
if __name__ == "__main__":
    print("=== BREVARD & DUVAL GOLD STANDARD AUTOPILOT ===")
    
    if not test_connection():
        sys.exit(1)
    
    print("\n=== Current Gold Standard Status (Database) ===")
    ...
    print("\n=== Fresh County Evaluations (LIVE METRICS) ===")
    assigned_counties = ['brevard', 'duval']
